...
import "./contact.css";
import { PhoneOutlined, MailOutlined, EnvironmentOutlined, TwitterOutlined, InstagramOutlined, MessageOutlined } from "@ant-design/icons";
  ...
  return (
    <div className="contactContainer">
      <div className="contactHeader">
        <h1 className="contactHeader_h1">Contact Us</h1>
