        ...
        <div>
          ...
          <List>
            {item.members.map((member: any, index: number) => (
              <List.Item key={member.id || index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <Button
                  type="primary"
                  shape="round"
                  style={{ backgroundColor: '#335DFF', border: 'none', marginTop: 10 }}
                  onClick={() => navigate(`/users`, { state: { user: document } })}
                >
                  View
                </Button>
                <Button
                  shape="round"
                  style={{ backgroundColor: 'transparent', border: 'solid 1px #335DFF', marginTop: 10, color: '#335DFF' }}
                >
                  Remove
                </Button>
              </div>
